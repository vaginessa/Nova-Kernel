...
#
# Nova-Kernel Build Script
# 
# Author: sunilpaulmathew <sunil.kde@gmail.com>
#
# Modified For Nova-Kernel
...
# 5. Open Terminal, ‘cd’ to the Kernel ‘root’ folder and run ‘. build_variant-Nova.sh’
# 6. The output (anykernel zip) file will be generated in the ‘release_Nova’ folder
...
GOOGLE="/home/skater187/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-"

UBERTC="/home/skater187/toolchains/UBERTC-8.2/bin/arm-none-eabi-"

LINARO="/home/skater187/toolchains/Linaro-7.x/bin/arm-linaro-linux-androideabi-"
...
KERNEL_VERSION="beta-v1.0"   # leave as such, if no specific version tag

KERNEL_DEFCONFIG="Nova_@$KERNEL_VARIANT@_defconfig"
...
ANYKERNEL_DIR="anykernel_Nova"

RELEASE_DIR="release_Nova"
...
if [ -z "$KERNEL_VARIANT" ]; then
	...
	make -C $(pwd) O=output_kltekor Nova_@kltekor@_defconfig
	# updating kernel version
	...
	make -C $(pwd) O=output_klte Nova_@klte@_defconfig
	# updating kernel version
	...
	make -C $(pwd) O=output_kltedv Nova_@kltedv@_defconfig
	# updating kernel version
	...
	make -C $(pwd) O=output_klteduos Nova_@klteduos@_defconfig
	# updating kernel version
	...
	make -C $(pwd) O=output_kltekdi Nova_@kltekdi@_defconfig
	# updating kernel version
